...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QtCore.QRect(0, 0, 155, 377))
        ...
        self.treeView_kg = Myclass.my_treeview(self.scrollAreaWidgetContents_10,scence=self.graphicsSence)
